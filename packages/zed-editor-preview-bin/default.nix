{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-N4vRNG6TixYgcsF7ItLp0f9t3TrS3a+zwyMQPx2W8bs=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-twDqQqOy3ecmGcolqYZVfRhU31CAyjxsU/BEv5CoJXc=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-3ZAaIabBRTk+JImU4uWzWh577DPCpUc+ga00mmb8RKs=";
      type = "dmg";
    };
  };

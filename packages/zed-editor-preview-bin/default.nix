{
  ...
  assets = {
    ...
    "aarch64-linux" = {
      ...
      sha256 = "sha256-8aNWA2RxXY5ww5/w8SW8ISb1opV+F+R00ypIuZTjCeY=";
      type = "tar.gz";
    };
    "x86_64-darwin" = {
      url =
      ...
      sha256 = "sha256-1FRCt13wA/Fxfeud6dqfEAKiOJ+Ax5h/vBEbOGV6O3Y=";
      type = "dmg";
    };
    "aarch64-darwin" = {
      url =
      ...
      sha256 = "sha256-w+jc+sXHwf0c4fNsNZEB8ARJ5q9eW7WKt5Ocz0lZJp4=";
      type = "dmg";
    };
  };
